...
console.log("Hasil Find ID 5:", findProductById(products, 5));

function getLowStockProducts(products) {
  return products.filter(product => product.stock < 10);
}
console.log("Hasil Low Stock:", getLowStockProducts(products));
...
console.log("Hasil Update Stock:", updateStock(products, 1, 50));